...
/**
 * GET /invoices/dash — optional KPI endpoint.
 * Production currently returns 404; callers should treat null as “use list stats”.
 */
export async function fetchInvoiceDashboard(params = {}) {
  try {
    const { data } = await apiClient.get(`${PATH}/dash`, { params })
